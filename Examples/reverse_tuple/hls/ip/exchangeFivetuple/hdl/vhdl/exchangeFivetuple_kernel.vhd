...
entity exchangeFivetuple_kernel is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of exchangeFivetuple_kernel is 
    ...
    signal tmp_2_fu_101_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp4_fu_91_p4 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_s_fu_81_p4 : STD_LOGIC_VECTOR (15 downto 0);
    signal in_extern_src_V_1_fu_67_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal in_extern_dst_V_fu_71_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal or_ln20_1_fu_111_p6 : STD_LOGIC_VECTOR (103 downto 0);
    ...
    component exchangeFivetuple_kernel_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    regslice_both_user_extern_in_U : component exchangeFivetuple_kernel_regslice_both
    generic map (
        DataWidth => 128)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_user_extern_out_U : component exchangeFivetuple_kernel_regslice_both
    generic map (
        DataWidth => 128)
    port map (
        ap_clk => ap_clk,
    ...
    in_extern_dst_V_fu_71_p4 <= user_extern_in_TDATA_int_regslice(63 downto 32);
    in_extern_src_V_1_fu_67_p1 <= user_extern_in_TDATA_int_regslice(32 - 1 downto 0);
    or_ln20_1_fu_111_p6 <= ((((tmp_2_fu_101_p4 & tmp4_fu_91_p4) & tmp_s_fu_81_p4) & in_extern_src_V_1_fu_67_p1) & in_extern_dst_V_fu_71_p4);
    tmp4_fu_91_p4 <= user_extern_in_TDATA_int_regslice(79 downto 64);
    tmp_2_fu_101_p4 <= user_extern_in_TDATA_int_regslice(103 downto 96);
    tmp_s_fu_81_p4 <= user_extern_in_TDATA_int_regslice(95 downto 80);
    ...
    user_extern_out_TDATA_int_regslice <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln20_1_fu_111_p6),128));
