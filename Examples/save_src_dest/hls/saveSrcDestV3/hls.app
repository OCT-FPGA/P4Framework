<project xmlns="com.autoesl.autopilot.project" name="saveSrcDestV3" top="saveSrcDest_kernel" projectType="C/C++">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="../test/test1.cpp" sc="0" tb="1" cflags="-I../include -I../src -I../include -I../src -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
