...
if {[file isfile saveSrcDest_kernel.autotvin.dat]} {
	file delete -force saveSrcDest_kernel.autotvin.dat
}

if {[file isfile saveSrcDest_kernel.autotvout.dat]} {
	file delete -force saveSrcDest_kernel.autotvout.dat
}
