...
#define WRAPC_STREAM_SIZE_IN_user_extern_in "../tv/stream_size/stream_size_in_user_extern_in.dat"
#define WRAPC_STREAM_INGRESS_STATUS_user_extern_in "../tv/stream_size/stream_ingress_status_user_extern_in.dat"
#define AUTOTB_TVOUT_user_extern_out "../tv/cdatafile/c.saveSrcDest_kernel.autotvout_user_extern_out.dat"
#define WRAPC_STREAM_SIZE_OUT_user_extern_out "../tv/stream_size/stream_size_out_user_extern_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_user_extern_out "../tv/stream_size/stream_egress_status_user_extern_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_user_extern_out "../tv/rtldatafile/rtl.saveSrcDest_kernel.autotvout_user_extern_out.dat"
...
extern "C"
void saveSrcDest_kernel_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_saveSrcDest_kernel_hw(void* __xlx_apatb_param_user_extern_in, void* __xlx_apatb_param_user_extern_out)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 64,
    .name = "user_extern_in",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_user_extern_in),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_user_extern_in),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_user_extern_in),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_user_extern_in),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_user_extern_in;
  port0.hasWrite = false;

  static hls::sim::Stream<hls::sim::Byte<8>> port1 {
    .width = 64,
    .name = "user_extern_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_user_extern_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_user_extern_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_user_extern_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_user_extern_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_user_extern_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    saveSrcDest_kernel_hw_stub_wrapper(__xlx_apatb_param_user_extern_in, __xlx_apatb_param_user_extern_out);
    port1.buffer();
