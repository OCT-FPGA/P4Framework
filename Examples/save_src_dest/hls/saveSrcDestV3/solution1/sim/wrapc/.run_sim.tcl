...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "saveSrcDest_kernel.autotvin.dat"
	set constFileTvOut       "saveSrcDest_kernel.autotvout.dat"
	set constFileHdlTvIn     "saveSrcDest_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "saveSrcDest_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
